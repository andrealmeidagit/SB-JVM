...
public class int_logico{
	public static void main(String args[]){
		...
		/*icmp*/
		if(a>b) System.out.println(a);	//10
		if(b<a) System.out.println(b);	//9
		...
		if(a==10) System.out.println("a igual a 10");	//check
		...
		if(a >= 0) System.out.println("a maior ou igual a 0");	//check
		

		
		if(array[0]==array[1]) System.out.println("indice 0 igual a indice 1");	
		if(array[0]!=array[2]) System.out.println("indice 0 diferente de indice 2");	//check
